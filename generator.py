...
def generate_json_points(num_points, output_file):
    data = []
    time_interval = 5  # Linearly increasing time interval
    ...
    for i in range(num_points):
        ...
        # Compute linearly increasing elapsed time
...
generate_json_points(num_points=25, output_file="points_data.json")
